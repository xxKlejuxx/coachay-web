/* COACHAY — Firebase Configuration
   Jeden plik konfiguracyjny dla całej aplikacji.
   Ładowany w login.html (bezpośrednio) i przez coachay-core.js (window.FIREBASE_CONFIG).
*/
